...
UVK::GLMesh::GLMesh(GLfloat* vertices, uint32_t* indices, uint32_t vertexNum, uint32_t indexNum)
{
    createMesh(vertices, indices, vertexNum, indexNum);
}
